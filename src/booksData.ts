...
export const booksData: Book[] = [
  ...
  {
    id: "zubdat-ul-nahw-sharh-hidayat-ul-nahw",
    title: "Zubdat-ul-Nahw Sharh Hidayat-ul-Nahw",
    pashtoTitle: "زبدة النحو شرح هداية النحو",
    author: "شيخ القرآن والحدیث الحاج ګل الرحمن حقاني (المهاجر المدني)",
    category: "language",
    categoryLabel: "ژبه او نحوي ضوابط",
    description: "دا کتاب د علمِ نحو په برخه کې یو مهم او ګټور شرح دی، چې د نحوي قواعدو د ښه فهم لپاره ځانګړی ارزښت لري. په دې کتاب کې د عربي نحو بنسټیز اصول، دقیق قواعد او باریک نحوي نکات په واضح او منظم انداز بیان شوي دي. یاد اثر د هغو طالبالعلمانو لپاره یو غوره لارښود ګڼل کېږي چې غواړي د نحو علم په اسانه، ژور او ترتیب شوی ډول زده کړي. پکې د جملو جوړښت، اعراب، قواعدي تحلیل او نور مهم نحوي مباحث په ساده خو علمي طرز تشریح شوي دي. همدارنګه په دې کتاب کې د نحوي مسایلو اړوند مهم فوائد، دقیق توضیحات او هغه باریک نکات بیان شوي چې د عربي ژبې په فهم کې بنسټیز رول لري، نو ځکه دا کتاب د مدرسو د زدهکوونکو لپاره یو ارزښتناک علمی مرجع بلل کېږي.",
    size: "3.0 MB",
    publishedYear: "۱۴۰۲",
    language: "pashto",
    difficulty: "medium",
    difficultyLabel: "منځنی",
    coverGradient: "from-[#1a2e40] to-slate-900",
    coverPattern: "geometric",
    pages: [
      { pageNumber: 1, chapterTitle: "مقدمة علم النحو", content: "د عربي نحوې بنسټیز اصول، د کلیمې وېش او د اسم، فعل او حرف ځانګړتیاوې او تعریفونه چمتو شوي دي." },
      { pageNumber: 2, chapterTitle: "اعراب او د جملو جوړښت", content: "د معرب او مبني بحث، د عاملونو اغېزه او په کلام کې د هر رکن نحوي تحلیل او دقیق اعرابونه پورتني لوست ته شرحه شوي دي." }
    ]
  },
  {
    id: "miraj-ul-nahw",
    title: "Miraj-ul-Nahw",
    pashtoTitle: "معراج النحو",
    author: "شيخ القرآن والحدیث الحاج ګل الرحمن حقاني (المهاجر المدني)",
    category: "language",
    categoryLabel: "ژبه او نحوي ضوابط",
    description: "د عربي نحوې له ګټورو او ارزښتناکو کتابونو څخه دی، چې د نحوې مهم قواعد، ضوابط او علمي فوائد په روان او آسانه انداز وړاندې کوي. دا کتاب د نحوې زدهکوونکو لپاره یو غوره مرجع ده او د عربي عبارتونو په صحیح فهم او تحلیل کې ورسره ډېره مرسته کوي. په دې کتاب کې د نحوې اساسي قواعد، د جملو جوړښت، د اعرابو پېژندنه, د کلام صحیح ترکیب، تطبیقي مثالونه او ګڼ نور علمي مباحث بیان شوي دي، چې د زدهکوونکو علمي بنیه پیاوړې کوي او د نحوې په زدهکړه کې ورته اسانتیا برابروي.",
    size: "2.5 MB",
    publishedYear: "۱۴۰۳",
    language: "pashto",
    difficulty: "beginner",
    difficultyLabel: "پیلیونکی",
    coverGradient: "from-[#0a3622] to-slate-950",
    coverPattern: "poetry",
    pages: [
      { pageNumber: 1, chapterTitle: "د معراج النحو پیلیزه", content: "د عربي کلیمې پېژندنه او د عامل او معمول بحث چې په علم نحو کې خورا ارزښت لري او لومړی علمي مبحث ګڼل کېږي." }
    ]
  },
  {
    id: "miraj-ul-waizin-farsi",
    title: "Miraj-ul-Waizin Farsi",
    pashtoTitle: "معراج الواعظين فارسي",
    author: "شيخ القرآن والحدیث الحاج ګل الرحمن حقاني (المهاجر المدني)",
    category: "islamic",
    categoryLabel: "اسلامي علوم او وعظ",
    description: "«معراج الواعظین» یکی از آثار ارزشمند شیخ القرآن والحدیث الحاج گلالرحمن حقانی المهاجر المدنی است که در زمینهٔ علوم اسلامی و اخلاق، بهویژه برای واعظان، خطیبان و دعوتگران، جایگاه ویژهای دارد. این کتاب منبعی مهم و سودمند به شمار میرود که در آن موضوعات گوناگون مربوط به احکام اسلامی، عقاید، فضایل اخلاقی و رویدادهای سیرت نبوی گردآوری شده است. این اثر بهعنوان راهنمایی جامع برای آمادهسازی سخنرانیها، موعظهها و برنامههای دینی تدوین گردیده و به اهل منبر و دعوت کمک میکند تا پیامهای اسلامی را به شیوهای منظم، مؤثر و مستند به مخاطبان خود ارائه نمایند. «معراج الواعظین» با محتوای علمی و تربیتی خود، در ترویج آگاهی دینی و تقویت ارزشهای اخلاقی نقش مهمی ایفا میکند.",
    size: "4.5 MB",
    publishedYear: "۱۴۰۰",
    language: "dari",
    difficulty: "medium",
    difficultyLabel: "متوسط",
    coverGradient: "from-[#321345] to-[#12051a]",
    coverPattern: "crest",
    pages: [
      { pageNumber: 1, chapterTitle: "مقدمه معراج الواعظین (فارسی)", content: "بیان ضرورت وعظ و ارشاد برای جامعه اسلامی، فضایل مبلغان دین مبین اسلام و صفات داعی مخلص و راهکارهای ترویج عقیده صحیحه." }
    ]
  }
];
